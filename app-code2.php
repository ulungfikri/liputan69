...
<!-- <script>
    mda_set("set", "VideoId", "0");
    mda_set("set", "VideoViews", "0");
    mda_set("set", "VideoCat", "0");
    mda_set("set", "UserId", "0");
    mda_send();
</script>  -->
...
<script type="text/javascript">
    ...
    function getInfo(res) {
        ...
        var url = 'http://menews.mncdigital.tv/getInfo.php?ids='+res;
    ...
    function getProf() {
        ...
        //}
        var xmlhttp2 =  new XMLHttpRequest();
        var url = 'http://menews.mncdigital.tv/getProf.php?id=' + encodeURIComponent(user_id) + '&siteid=4';
    ...
    function getRecommendationList() {
        ...
        xmlhttp.open('POST', 'http://menews.mncdigital.tv/recommlist.php', true);
        ...
        if(debug)console.log('getRecommendationList username:', user_id);
    ...
    function getAdvProfile() {
        var res;
        var xmlhttp =  new XMLHttpRequest();
         xmlhttp.open('POST', 'http://menews.mncdigital.tv/advprofile.php', true);
        xmlhttp.onreadystatechange = function() {
            if(xmlhttp.readyState == 4) {
                if(xmlhttp.status != 200) {
